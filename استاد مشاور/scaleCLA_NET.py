...
#
#         if(t>3):
#             Delta[t] =deltacounter(MVC)
#             # print('dddddddddddddd',Delta)
#             flag1,term1 = teminationcondition1(Qfinal,term1) #const Q
#             flag2, term2 = teminationcondition2(Delta,term2 )  # const Mvc
#
